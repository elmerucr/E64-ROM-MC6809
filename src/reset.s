...
rom_version:	db	'E64-ROM v0.4 20221001',0

exc_reset:	; set stackpointers
		lds	#$0800		; this write to sp will enable nmi's as well
		ldu	#$c000		; initial value might be changed by software

		jsr	init_vectors

		jsr	blitter_clear_kernel_displ_list
		jsr	blitter_init_blit_0	; this blit is used for main kernel text screen
		jsr	blitter_init_displ_list
		jsr	blitter_set_bordersize_and_colors

		; activate irq's generated by machine/screen refresh
		lda	#$01
		sta	MACHINE_CR
...
init_vectors:	pshs	x
		...
		ldx	#blitter_irq_handler
		stx	VECTOR_BLITTER_INDIRECT
		ldx	#timer0_irq
